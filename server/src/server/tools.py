...
from ml_agent.ml_tools import create_ml_training_tool
...
def create_tools(knowledge_base=None, podcast_knowledge_base=None, agentkit=agent_kit):
    ...
    # Add ML training tool if enabled
    if os.getenv("USE_ML_TOOLS", "true").lower() == "true":
        tools.append(create_ml_training_tool())
